...
define config.name = _("Cytoid: Song of Sakura")
...
define config.main_menu_music = "audio/tenderness.mp3"
...
define config.save_directory = "cchan-1486779676"
